...
async function inspectSignal(asset) {
  ...
  if (activeTrades.has(key)) return false;
...
app.listen(PORT, '0.0.0.0', () => console.log(`SetupDT Light V2.0 Varredura Automática online na porta ${PORT}`));
